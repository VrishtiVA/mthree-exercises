...
public class AllTheMaths {
    public static void main(String[] args) {
        ...
        System.out.println("42001 modulus 5 is: " + (42001 % 5));
        System.out.println("5565.0 divided by 22.0 is: " + (5565.0 / 22.0));
        System.out.println("223 times 31 - 42: " + (223 * 31 - 42));
        System.out.println("Is 4 > -1: " + (4 > -1));
